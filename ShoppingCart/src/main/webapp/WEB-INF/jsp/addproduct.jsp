...
<!------ Include the above in your HEAD tag ---------->
  ...
  <div class="row">
    <div class="col-md-4 col-md-offset-4">
      <form class="form-horizontal" role="form" action="/saveproduct" method="post" modelAttribute="product">
        <fieldset>
...
-->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" placeholder="brand" class="form-control" name="brand" id="brand">
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" placeholder="unitPrice" class="form-control" name="unitPrice" id="unitPrice">
            </div>
          </div>
      ...
      -->     
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" placeholder="categoryId" class="form-control" name="categoryId" id="categoryId">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="number" placeholder="supplierId" class="form-control" name="supplierId" id="supplierId">
            </div>
          </div>
